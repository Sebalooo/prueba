                ...
                <x-table>
                    <div class="px-6 py-4 flex items-center">
                        <div class="flex items-center">
                            ...
                            <span>
                                Entradasssssssssssssssssssss
                            </span>
                        </div>
        
                        <input type="text" class="w-full flex-1 mx-4" placeholder="Escriba busqueda para filtrarrrrrrrrrrrra"
                            wire:model='search'>
        
                            @livewire('repuestos.crear-repuestos')
                    </div>
                                        ...
                                        <td class="px-6 py-4">
                                            {{$item->modelo}}
                                               ...
                                               //Botones para editar y eliminar
                                                ...
                                                <td class="px-6 py-4 ">
                                                    {{-- @livewire('inventario.editar-inventario', ['inventario' => $inv], key($inv->id)) --}}
                                                    <a class="btn btn-red" wire:click="$emit('borrarRepuestos',{{$item->id}})">
    ...
    <x-jet-dialog-modal  wire:model="open_edit">
        ...
        <x-slot name="content">
            <div class="mb-4">
                ...
                <x-jet-input wire:model="repuestos.nombre" type="text" class="w-full" />
                <x-jet-input-error for='repuestos.nombre'/>
            </div>
            <div class="mb-4">
                <x-jet-label value="serie" />
                <x-jet-input wire:model=repuestos.serie" type="text" class="w-full" />
                <x-jet-input-error for='repuestos.serie'/>
            </div>
            <div class="mb-4">
                <x-jet-label value="Marca" />
                <x-jet-input wire:model="repuestos.marca" type="text" class="w-full" />
                <x-jet-input-error for='repuestos.marca'/>
            </div>
            <div class="mb-4">
                <x-jet-label value="Modelo" />
                <x-jet-input wire:model="repuestos.modelo" type="text" class="w-full" />
                <x-jet-input-error for='repuestos.modelo'/>
            </div>
        ...
        <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire(
                        'Eliminado!',
                        'El Item ha sido eliminado del sistema.',
                        'success'
                    )
                }
            })
